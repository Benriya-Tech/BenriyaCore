...
namespace Benriya.Utils
{
    ...
    {
        private static readonly Dictionary<ImageFileType, byte[]> KNOWN_FILE_HEADERS = new Dictionary<ImageFileType, byte[]>()
        {
            { ImageFileType.Jpeg, new byte[]{ 0xFF, 0xD8 }}, // JPEG
		    { ImageFileType.Bmp, new byte[]{ 0x42, 0x4D }}, // BMP
		    { ImageFileType.Gif, new byte[]{ 0x47, 0x49, 0x46 }}, // GIF
		    { ImageFileType.Png, new byte[]{ 0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A }} // PNG
	    };

        public static ImageFileType GetKnownFileType(ReadOnlySpan<byte> data)
        {
    ...
    {
        public static readonly string[] _validExtensions = { "image/jpg", "image/bmp", "image/gif", "image/png","image/jpeg" }; //  etc
