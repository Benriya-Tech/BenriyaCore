...
namespace Benriya.Data.Migrator.Migrations
{
    ...
    [Migration("20201226074851_add_color_store")]
    partial class add_color_store
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Benriya.Modules.CMS.Share.Models.Category_Tags", b =>
                {
                    ...
                    b.HasIndex("category_id")
                        .HasDatabaseName("IX_CMS_Category_Tags_cate_id");

                    b.HasIndex("id")
                        .IsUnique();

                    b.HasIndex("tag_id")
                        .HasDatabaseName("IX_CMS_Tags_tag_id");
            ...
            modelBuilder.Entity("Benriya.Modules.Inventory.Share.Models.Products.Goods", b =>
                {
                    ...
                    b.Property<bool>("is_color")
                        .HasColumnType("boolean");

                    b.Property<bool>("is_type_color")
                        .HasColumnType("boolean");

                    b.Property<bool>("is_weight")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Benriya.Modules.Inventory.Share.Models.Products.Goods_Color", b =>
                {
                    ...
                    b.HasIndex("color_id")
                        .HasDatabaseName("IX_Goods_Colors_Store_id");
            ...
            modelBuilder.Entity("Benriya.Share.Models.Colors.Color_Store", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("hex_code")
                        .IsUnique()
                        .HasDatabaseName("IX_Color_Store_hexcode");

                    b.HasIndex("id")
                        .IsUnique()
                        .HasDatabaseName("IX_Color_Store_id");

                    b.HasIndex("name")
                        .IsUnique()
                        .HasDatabaseName("IX_Color_Store_name");

                    b.ToTable("color_store");
                });
            ...
            modelBuilder.Entity("Benriya.Share.Models.FileStore.FileStore_FileType", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Benriya.Share.Models.Helpers.Weight_Type", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("id")
                        .IsUnique()
                        .HasDatabaseName("IX_Weight_Type_id");

                    b.HasIndex("name")
                        .IsUnique()
                        .HasDatabaseName("IX_Weight_Type_name");

                    b.HasIndex("short_name")
                        .IsUnique()
                        .HasDatabaseName("IX_Weight_Type_short_name");

                    b.ToTable("weight_type");
                });
            ...
            modelBuilder.Entity("Benriya.Modules.Inventory.Share.Models.Products.Goods_Color", b =>
                {
                    b.HasOne("Benriya.Share.Models.Colors.Color_Store", "Color")
                        .WithMany()
            ...
            modelBuilder.Entity("Benriya.Share.Models.FileStore.FileStore_Documents", b =>
                {
                    b.HasOne("Benriya.Share.Models.FileStore.FileStore_FileType", "FileType")
                        .WithMany("Documents")
