...
{
    public partial class ContentListBase : DataListBase<Contents>, IDisposable
    {        
        ...
        protected override void ShowForm(Contents data = null)
        {
            _NavigationManager.NavigateTo($"{ClientMudule.AdminPath}/contentform/{(data != null ? data.id.ToString() : null)}");
        }
