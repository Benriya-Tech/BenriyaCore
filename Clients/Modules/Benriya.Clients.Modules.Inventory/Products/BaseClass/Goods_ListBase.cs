...
{
    public class Goods_ListBase : DataListBase<Goods>, IDisposable
    {
        ...
        protected override void ShowForm(Goods data = null)
        {
            _NavigationManager.NavigateTo($"/admin/inventory/goods/form/{(data != null ? data.id.ToString() : null)}");
        }
